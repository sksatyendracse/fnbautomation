							...
							<div class="user-item" id="review-<?= $v['review_id']; ?>">
								...
								<div class="user-item-description">
									...
									<div class="controls">
										...
										<a href="#" id="activator-<?= $v['review_id']; ?>" class="btn btn-default btn-xs"><i class="fa fa-pencil" aria-hidden="true"></i> <?= $txt_edit_review; ?>
										</a>
									</div><!-- .controls -->
								</div>
...
<?php
$js_inc = __DIR__ . '/../js/user_js/js-my-reviews.php';
