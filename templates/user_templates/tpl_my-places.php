...
<div class="wrapper">
 ...
 <?= $txt_remove_place; ?>
									...
									<a href="<?= $baseurl; ?>/user/edit-place/<?= $v['place_id']; ?>" class="btn btn-default btn-xs"
										data-edit-id="<?= $v['place_id']; ?>"><i class="fa fa-pencil" aria-hidden="true"></i>
 <?= $txt_edit_place; ?>
									</a>

									<span class="btn btn-default btn-xs"><?= $v['status']; ?></span>
								</div><!-- .controls -->
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary remove-place" data-dismiss="modal" data-remove-id>Remove this place</button>
			</div>
		</div>
	</div>
...
<?php
$js_inc = __DIR__ . '/../js/user_js/js-my-places.php';
