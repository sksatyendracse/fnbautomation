...
if(basename($_SERVER['SCRIPT_NAME']) == 'my-coupons.php') {
	$menu_my_coupons_active = 1;
}
...
$txt_coupons = (!empty($txt_coupons)) ? $txt_coupons : "Coupons";
?>
<ul>
	<li>
	...
	<li>
		<a href="<?= $baseurl; ?>/user/my-coupons" <?= ($menu_my_coupons_active) ? 'class="active"' : ''; ?>>
			<i class="fa fa-tag" aria-hidden="true"></i>
			<span class="menu-txt"><?= $txt_my_coupons; ?></span>
		</a>
	</li>
	<li>
