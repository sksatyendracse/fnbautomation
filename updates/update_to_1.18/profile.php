...
// rows
$prof_first_name    = $row['first_name'];
$prof_last_name     = $row['last_name'];
$prof_city_name     = $row['city_name'];
$prof_country_name  = $row['country_name'];
$created            = $row['created'];
...
// sanitize vars
$prof_first_name      = e(trim($prof_first_name));
$prof_last_name       = e(trim($prof_last_name));
$profile_display_name = e(trim($profile_display_name));
$prof_city_name       = e(trim($prof_city_name));
$prof_country_name    = e(trim($prof_country_name));
...
// template file
if(is_file(__DIR__ . '/templates/my_tpl_profile.php')) {
	require_once(__DIR__ . '/templates/my_tpl_profile.php');
}
