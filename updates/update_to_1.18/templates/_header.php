<?php
if(file_exists(__DIR__ . '/my_header.php') && basename(__FILE__) != 'my_header.php') {
	include_once('my_header.php');
	return;
}
?>
			...
			<div class="collapse navbar-collapse" id="bs-navbar">
				<div class="collapse-header clearfix">
					...
					<ul class="nav navbar-nav navbar-right" id="main-menu">
						...
						<!-- coupons link -->
						<li>
							<a href="<?= $baseurl; ?>/coupons" class="btn btn-ghost">
		...
		<form id="main-search-form" method="GET" action="<?= $baseurl; ?>/_searchresults.php" role="search">
			<div class="clearfix">
				...
				<div id="city-input-wrapper">
					<select id="city-input" name="city_id">
