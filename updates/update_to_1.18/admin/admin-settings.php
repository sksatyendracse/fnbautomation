...
// v. 1.10
// translation var check if exists, if not, set default
$txt_mapbox_secret         = !empty($txt_mapbox_secret        ) ? $txt_mapbox_secret          : "MapBox Access Token";
$txt_tomtom_secret         = !empty($txt_tomtom_secret        ) ? $txt_tomtom_secret          : "TomTom Key";
$txt_here_key              = !empty($txt_here_key             ) ? $txt_here_key               : "HERE App ID";
$txt_here_secret           = !empty($txt_here_secret          ) ? $txt_here_secret            : "HERE App Code";
$txt_map_provider          = !empty($txt_map_provider         ) ? $txt_map_provider           : "Map Provider";

// translation var check if exists, if not, set default
// v. 1.17
$txt_city_autocomplete    = !empty($txt_city_autocomplete     ) ? $txt_city_autocomplete      : "City Autocomplete";
...
// get real value of $paypal_merchant_id
...
<div class="wrapper">
	...
	<div class="main-container">
		...
		<div class="padding">
			...
			<!-- Tab panes -->
			<form method="post" action="admin-process-settings.php" autocomplete="off">
				...
				<div class="block tab-content">
					...
					<div role="tabpanel" class="tab-pane active" id="general">
						...
						<div class="form-row">
							<strong><?= $txt_map_provider; ?></strong><br>
						...
						<div class="form-row">
							<strong><?= $txt_city_autocomplete; ?></strong><br>
					...
					<div role="tabpanel" class="tab-pane" id="email">
						...
						<div class="form-row">
							...
							<input type="text" id="smtp_pass" name="smtp_pass" class="form-control" value="<?= $smtp_pass; ?>" autocomplete="off">
						</div>
					...
					<div role="tabpanel" class="tab-pane" id="apis">
						...
						<div class="form-row">
							<strong><?= $txt_mapbox_secret; ?></strong><br>
							<input type="text" id="mapbox_secret" name="mapbox_secret" class="form-control" value="<?= $mapbox_secret; ?>">
						</div>

						<div class="form-row">
							<strong><?= $txt_tomtom_secret; ?></strong><br>
							<input type="text" id="tomtom_secret" name="tomtom_secret" class="form-control" value="<?= $tomtom_secret; ?>">
						</div>

						<div class="form-row">
							<strong><?= $txt_here_key; ?></strong><br>
							<input type="text" id="here_key" name="here_key" class="form-control" value="<?= $here_key; ?>">
						</div>

						<div class="form-row">
							<strong><?= $txt_here_secret; ?></strong><br>
							<input type="text" id="here_secret" name="here_secret" class="form-control" value="<?= $here_secret; ?>">
						</div>
					</div><!-- .tab-pane -->
