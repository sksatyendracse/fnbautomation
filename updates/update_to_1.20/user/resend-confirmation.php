...
// template file
if(is_file(__DIR__ . '/templates/user_templates/my_tpl_resend-confirmation.php')) {
	require_once(__DIR__ . '/templates/user_templates/my_tpl_resend-confirmation.php');
}
