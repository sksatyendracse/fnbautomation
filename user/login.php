...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if($status == 'approved') {
		...
		if(password_verify($password, $password_hashed)) {
			...
			if(!empty($referrer)) {?>
			<script>
				localStorage.setItem("loggedin_token", "<?php echo $token;?>");
...
// template file
if(is_file(__DIR__ . '/templates/user_templates/my_tpl_login.php')) {
	require_once(__DIR__ . '/templates/user_templates/my_tpl_login.php');
}
else {
