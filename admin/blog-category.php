...
$query = "SELECT * FROM blog_category ORDER BY name LIMIT $start_from, $per_page_record";     
			...
			<div class="sb2-2">
				...
				<div class="tz-2 tz-2-admin">
					<div class="tz-2-com tz-2-main">
						<h4>Blog Categories <a href="<?= $baseurl; ?>/admin/blog-category-add/" class="add-btn">Add New</a></h4>
						<!-- Dropdown Structure -->
						<div class="split-row">
							<div class="col-md-12">
											...
											<table class="table table-hover">
												...
												?>   
													<tr>
														...
														<td><a href="#"><span class="list-enq-name"><?php echo $row['name'];?></span></a> </td>
                              ...
                              <div class="btn-set">
                                <a class="dropdown-button drop-down-meta" href="#" data-activates="dr-list2<?php echo $row['id']?>"><i class="material-icons">more_vert</i></a>
            										<ul id="dr-list2<?php echo $row['id']?>" class="dropdown-content">
            											<li><a href="<?= $baseurl; ?>/admin/blog-category-edit/<?php echo $row['id'];?>">Edit</a> </li>
            											<li><a href="<?= $baseurl; ?>/admin/blog-category-delete/<?php echo $row['id'];?>" data-blog-id="<?php echo $row['id'];?>" class="remove-blog-category">Delete</a> </li>
            										</ul>
                              </div>
                            </td>
													</tr>
