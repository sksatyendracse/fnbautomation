...
$notify_url                   = !empty($_POST['notify_url'                  ]) ? $_POST['notify_url'                  ] : '';
...
$_2checkout_sid               = !empty($_POST['_2checkout_sid'              ]) ? $_POST['_2checkout_sid'              ] : '';
$_2checkout_sandbox_sid       = !empty($_POST['_2checkout_sandbox_sid'      ]) ? $_POST['_2checkout_sandbox_sid'      ] : '';
$_2checkout_secret            = !empty($_POST['_2checkout_secret'           ]) ? $_POST['_2checkout_secret'           ] : '';
$_2checkout_currency_code     = !empty($_POST['_2checkout_currency_code'    ]) ? $_POST['_2checkout_currency_code'    ] : '';
$_2checkout_currency_symbol   = !empty($_POST['_2checkout_currency_symbol'  ]) ? $_POST['_2checkout_currency_symbol'  ] : '';
$_2checkout_lang              = !empty($_POST['_2checkout_lang'             ]) ? $_POST['_2checkout_lang'             ] : '';
$_2checkout_notify_url        = !empty($_POST['_2checkout_notify_url'       ]) ? $_POST['_2checkout_notify_url'       ] : '';
$_2checkout_notify_url        = !empty($_POST['_2checkout_notify_url'       ]) ? $_POST['_2checkout_notify_url'       ] : '';
$mercadopago_client_id        = !empty($_POST['mercadopago_client_id'       ]) ? $_POST['mercadopago_client_id'       ] : '';
$mercadopago_client_secret    = !empty($_POST['mercadopago_client_secret'   ]) ? $_POST['mercadopago_client_secret'   ] : '';
$mercadopago_currency_id      = !empty($_POST['mercadopago_currency_id'     ]) ? $_POST['mercadopago_currency_id'     ] : '';
$mercadopago_notification_url = !empty($_POST['mercadopago_notification_url']) ? $_POST['mercadopago_notification_url'] : '';
...
try {
	...
	$query = "INSERT INTO config(type, property, value) VALUES
		...
		('cfg'    , 'cfg_use_select2'             , :cfg_use_select2             )
		";
